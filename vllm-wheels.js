...
const vllmWheels = [
  ...
  // v0.10.0 (CUDA 11.8, 12.6 support)
  ...
  // v0.8.5.post1 (CUDA 11.8, 12.1, 12.4 support)
  ...
  // v0.8.4 (CUDA 11.8, 12.1, 12.4 support)
  ...
  // v0.8.3 (CUDA 11.8, 12.1, 12.4 support)
  ...
  // v0.8.2 (CUDA 11.8, 12.1, 12.4 support)
  ...
  // v0.8.0 (CUDA 11.8, 12.1, 12.4 support)
  ...
  // v0.6.6.post1 (CUDA 11.8, 12.1 support)
  ...
  // v0.6.1.post2 (CUDA 11.8, per-Python wheels)
  ...
  // v0.5.5 (CUDA 11.8, per-Python wheels)
  ...
  // v0.5.4 (CUDA 11.8, 12.1, per-Python wheels)
